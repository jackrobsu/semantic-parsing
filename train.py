...
tf.app.flags.DEFINE_string('source_vocabulary', 'data/seq2seq/geoqueries/data/a_question.json', 'Path to source vocabulary')
tf.app.flags.DEFINE_string('target_vocabulary', 'data/seq2seq/geoqueries/data/a_answer.json', 'Path to target vocabulary')
tf.app.flags.DEFINE_string('source_train_data', 'data/seq2seq/geoqueries/data/train_question', 'Path to source training data')
tf.app.flags.DEFINE_string('target_train_data', 'data/seq2seq/geoqueries/data/train_answer', 'Path to target training data')
tf.app.flags.DEFINE_string('source_valid_data', 'data/seq2seq/geoqueries/data/test_question', 'Path to source validation data')
tf.app.flags.DEFINE_string('target_valid_data', 'data/seq2seq/geoqueries/data/test_answer', 'Path to target validation data')
...
tf.app.flags.DEFINE_integer('save_freq', 10, 'Save model checkpoint every this iteration')
...
def create_model(session, FLAGS):
    ...
    model = Seq2SeqModel(FLAGS, 'train', config)
