...
class Seq2SeqModel(object):
    ...
    def __init__(self, FLAGS, mode, config):
        ...
        self.num_encoder_symbols = FLAGS.num_encoder_symbols
        self.num_decoder_symbols = FLAGS.num_decoder_symbols

        self.use_residual = FLAGS.use_residual
        self.attn_input_feeding = FLAGS.attn_input_feeding
        self.use_dropout = FLAGS.use_dropout
        self.keep_prob = 1 - FLAGS.dropout_rate
        ...
        self.dtype = tf.float16 if FLAGS.use_fp16 else tf.float32
